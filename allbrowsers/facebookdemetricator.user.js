...
var VERSION_NUMBER = '1.7.3';       // used in the console logging
...
function main() {
    ...
    console.log("browser --> "+Object.keys(j.browser));
    var browsername = "(unknown browser)";


    if(j.browser.chrome != undefined) {
        IS_SAFARI_OR_FIREFOX_ADDON = false;
        IS_CHROME_ADDON = true;
        browsername = "(Chrome)";
    } else if(j.browser.mozilla!= undefined) {
        IS_SAFARI_OR_FIREFOX_ADDON = true;
        IS_FIREFOX_ADDON = true;
        IS_CHROME_ADDON = false;
        browsername = "(Firefox)";
    } else if(j.browser.safari != undefined) {
        IS_SAFARI_OR_FIREFOX_ADDON = true;
        browsername = "(Safari)";
    } else {
        IS_SAFARI_OR_FIREFOX_ADDON = true;
    ...
    // console reporting
    console.log("Facebook Demetricator v"+VERSION_NUMBER+" "+browsername);
        ...
        if(nl.length > 0) {
            ...
            for(var i = 0; i < nl.length; ++i) {
                ...
                if(nlc.contains("uiContextualLayerPositioner")) {
                    ...
                    if(j(nl[i]).find('.uiTooltipX') && !nlc.contains("fbd_tracked")) {
                        attachTooltipDemetricator(j(nl[i]));
                    }
